...
const insertCustomer = (data) =>{
    ...
    return Pool.query(`INSERT INTO customer (id_customer,name,phone,password,email,gender,dob) VALUES(${id},'${name}','${phone}','${password}','${email}','${gender}','${dob}')`);
}

const updateCustomer = (data) =>{
    const { id,name,phone,password,email,gender,dob} = data;
    return Pool.query(`UPDATE customer SET name='${name}', phone='${phone}', password='${password}', email='${email}',gender='${gender}', dob='${dob}' WHERE id_customer=${id}`);
}
